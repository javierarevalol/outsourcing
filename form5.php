  ...
  <fieldset>
    ...
    <form>
      ...
      <label>Actividad a Realizar:
        <select name="act_1">
          <option value="Actividades HSE">Actividades HSE</option>
        </select>
      </label><br>
        ...
        <div class="firma-entry">
          <label>Paso a Paso de la Actividad:
              <select name="act_2">
                ...
                <option value="Actividades HSE">3. Actividades HSE</option>
          ...
          <div class="firma-container">
            <div class="firma-entry">
              ...
              <label>Barreras de Seguridad:
                <select name="medida_preventiva2">
                  <option value="">NA</option>
