  ...
  <fieldset>
    ...
    <form>
      ...
      <label>Actividad a Realizar:
        <select name="act_1">
          <option value="Revisión e Instalación de Equipos de Medida Directa">Revisión e Instalación de Equipos de Medida Directa</option>
          <option value="Verificación de Amarres">Verificación de Amarres</option>
          <option value="Primera Lectura">Primera Lectura</option>
          <option value="Segunda Lectura">Segunda Lectura</option>
          <option value="Lectura de Macromedidas">Lectura de Macromedidas</option>
          <option value="Revisión de Fronteras">Revisión de Fronteras</option>
          <option value="Censo Alumbrado Navideño">Censo Alumbrado Navideño</option>
          <option value="Alumbrado Público">Alumbrado Público</option>
          <option value="Normalización">Normalización</option>
          <option value="Instalación de Macromedidas">Instalación de Macromedidas</option>
        </select>
      </label><br>
        ...
        <div class="firma-entry">
          <label>Paso a Paso de la Actividad:
              <select name="act_2">
                ...
                <option value="Desconexión y Aislamiento de Parciales de Carga del Usuario">7. Desconexión y Aislamiento de Parciales de Carga del Usuario</option>
                <option value="Conexión Carga Resistiva. Pruebas a Medidor y Toma de Datos">8. Conexión Carga Resistiva. Pruebas a Medidor y Toma de Datos</option>
                <option value="Retiro de Carga Resistiva. Desconexión de Medidor y Aislamieno Puntas">8.1. Retiro de Carga Resistiva. Desconexión de Medidor y Aislamieno Puntas</option>
                <option value="Montaje y Conexionado de Nuevo Medidor. Pruebas de Funcionamiento">8.2. Montaje y Conexionado de Nuevo Medidor. Pruebas de Funcionamiento</option>
                <option value="Conexión de Parciales de Carga. Restablecimiento de Servicio">9. Conexión de Parciales de Carga. Restablecimiento de Servicio</option>
                <option value="Sellado de Medidor. Recolección de Residuos Sólidos">10. Sellado de Medidor. Recolección de Residuos Sólidos</option>
                <option value="Ascenso a Estructura o Poste (Pretales)">11. Ascenso a Estructura o Poste (Pretales)</option>
                <option value="Posicionamiento de Escalera en Estructura. Anclaje y Montaje de Línea de Vida">11.1. Posicionamiento de Escalera en Estructura. Anclaje y Montaje de Línea de Vida</option>
                <option value="Ascenso a Estructura. Posicionamiento y Toma de Datos">11.2. Ascenso a Estructura. Posicionamiento y Toma de Datos</option>
                <option value="Anclaje y Posicionamiento en Altura. Toma de Datos y Registro Fotográfico">12. Anclaje y Posicionamiento en Altura. Toma de Datos y Registro Fotográfico</option>
                <option value="Descenso de Estructura o Poste">13. Descenso de Estructura o Poste</option>
                <option value="Desplazamiento en Vehículo. De Sitio de Trabajo a Oficina">14. Desplazamiento en Vehículo. De Sitio de Trabajo a Oficina</option>
              </select><br><br>
