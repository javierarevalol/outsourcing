  ...
  <fieldset>
    ...
    <form>
      ...
      <label>Actividad a Realizar:
        <select name="act_1">
          <option value="Actividades de Gestión Social">Actividades de Gestión Social</option>
        </select>
      </label><br>
        ...
        <div class="firma-entry">
          <label>Paso a Paso de la Actividad:
              <select name="act_2">
                ...
                <option value="Visitas de Gestión">3. Visitas de Gestión</option>
                <option value="Desplazamiento en Vehículo. De Sitio de Trabajo a Oficina">4 . Desplazamiento en Vehículo. De Sitio de Trabajo a Oficina</option>
              </select><br><br>
            ...
            <div class="firma-entry">
              <label>Riesgo Potencial en Seguridad y Ambiente:
                <select name="riesgo2">
                  ...
                  <option value="Caída al Mismo Nivel">Caída al Mismo Nivel</option>
                  <option value="Caída a Diferente Nivel">Caída a Diferente Nivel</option>
              ...
              <label>Barreras de Seguridad:
                <select name="medida_preventiva">
                  <option value="">NA</option>
                  <option value="Uso de cinturón de seguridad">Uso de cinturón de seguridad</option>
                  <option value="Uso de luces altas, bajas, estacionarias y direccionales">Uso de luces altas, bajas, estacionarias y direccionales</option>
                  ...
                  <option value="Casco, balaclava y guantes de vaqueta">Casco, balaclava y guantes de vaqueta</option>
